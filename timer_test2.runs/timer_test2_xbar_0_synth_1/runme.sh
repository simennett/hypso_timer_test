...
HD_PWD='/home/hypso/Documents/vivado/timer_test2/timer_test2.runs/timer_test2_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log timer_test2_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source timer_test2_xbar_0.tcl
