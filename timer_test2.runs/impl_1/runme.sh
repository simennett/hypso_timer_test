...
HD_PWD='/home/hypso/Documents/vivado/timer_test2/timer_test2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log timer_test2_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source timer_test2_wrapper.tcl -notrace
