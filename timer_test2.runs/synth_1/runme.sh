...
HD_PWD='/home/hypso/Documents/vivado/timer_test2/timer_test2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log timer_test2_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source timer_test2_wrapper.tcl
